			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
				...
				<form id="formRegister" class="topBefore" action="Servlet?opcion=altaUsuario" method="post">
					...
					<div class="form-group">
						...
						<label for="exampleInputEmail1">Introduce una Contraseña </label>
						<input id="contraseña"class="form-control" type="password" placeholder="Contraseña" name ="contraseña">
